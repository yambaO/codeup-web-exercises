...
//     if(moreCars[i].make.startsWith("f")){
//         console.log(moreCars[i].model);
//     }
// }

// for(let i = 0; i < moreCars.length; i++){
//     if(moreCars[i].make === "Ford"){
//         console.log(`${moreCars[i].make} ${moreCars[i].model} with mileage: ${moreCars[i].mileage}`);
//     }
// }

function lessThan50K
(carObject){
...
const Q5 = { make: 'Audi', model: 'Q5', mileage: 56789 };

console.log(lessThan50K(Q5));
console.log(moreCars[3]);
